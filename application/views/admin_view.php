			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-buttons navbar-header pull-right  collapse navbar-collapse" role="navigation">
					...
					<?php
						...
						$query =  $this->db->query('select * FROM tm_order where  fd_tgl_order < DATE_SUB(now(), INTERVAL 5 MINUTE)');

						foreach ($query->result() as $value) {

							$tgl = $value->fc_kdorder;
					...
					?>
						...
						<li class="purple">
							...
							<a data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="true">
								...
								<span class="badge badge-important" id="notifikasi"></span>
							...
							<ul class="dropdown-menu-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-close">
								...
								<li class="dropdown-header">
									...
									<span id="notifikasine"></span> Notifications
						...
						<li class="green">
							<a data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="true">
								...
								<span class="badge badge-success" id="notifikasi_voucher"></span>
							</a>

							<ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								<li class="dropdown-header">
									<i class="ace-icon fa fa-envelope-o"></i>
									<span id="notifikasi_vouchere"></span> Messages
								</li>

								<li class="dropdown-content ace-scroll" style="position: relative;"><div class="scroll-track scroll-active scroll-hover" style="display: block; height: 200px;"><div class="scroll-bar" style="height: 111px; top: 0px;"></div></div><div class="scroll-content" style="max-height: 200px;">
									<ul class="dropdown-menu dropdown-navbar">
									    <div id="detail_voucher"> </div>	
						...
						<li class="grey">
							<a data-toggle="dropdown" class="dropdown-toggle" href="#">
								...
								<span class="badge badge-grey" id="notifikasi_keranjang"></span>
							</a>

							<ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								<li class="dropdown-header">
									<i class="ace-icon fa fa-tasks"></i>
									<span id="notifikasi_keranjange"></span>
								</li>
