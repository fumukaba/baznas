...
<div class="box-header">
	...
	<a class="btn btn-danger" href="<?php echo base_url('Bpb/add')?>"><i class="fa fa-plus"></i> Tambah Data</a>
</div><br />
   ...
   $('#frm-example').on('submit', function(e){
    ...
    function format ( d ) {
	   ...
	   var parah='';
        ...
        .done(function (data) {
            var no = 1; 
            var atas = '<table class="table table-striped" cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;"><tr><td>No</td><td>No Bpb</td><td>Barang</td><td>Qty Terima</td><td>Harga Satuan</td><td>Subtotal</td><td>Aksi</td></tr><tr>';
            var bawah = '</table>';
            var tengah = '';
            var gabung = '';
            $.each(data, function (key, val) {
                tengah+='<tr><td>' + no + '</td><td>' + val.fc_nobpb + '</td><td>' + val.fc_kdbarang + '</td><td>' + val.fn_qtyterima + '</td><td>' + val.fm_harsat + '</td><td>' + val.fm_subtot + '</td><td>' + val.aksi + '</td></tr>';
                no++;
            });
