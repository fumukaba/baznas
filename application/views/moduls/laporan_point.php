...
<?php $title = "<i class='fa fa-money'></i>&nbsp;Laporan Pencairan Poin"; ?>
...
<div class="box-header">
  <form id="formAksine" class="form-horizontal" action="<?php echo base_url('Point/prints') ?>" target="_blank" method="POST" role="form" enctype="multipart/form-data">
  <div class="form-group">
    <div class="col-sm-6">
    <select name="nama" class="form-control">
    <option value="">Pilih Nama Yang Akan di Cetak</option>
    <?php foreach ($user as $u) { ?>
    <option value="<?php echo $u["id_user"] ?>"><?php echo $u["id_user"] ?></option>
    <?php } ?>
    </select>
