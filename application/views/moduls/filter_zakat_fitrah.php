...
<table id="example" class="display responsive nowrap" cellspacing="0" width="100%">
    ...
    <?php foreach($semua_data as $data) { ?>
        ...
        <tr>
            ...
            <td><?php echo $data['total_zakat']. "<br>" . $convert_zis_1. "<br>" . $convert_zis_2; ?></td>
            <td><?php echo $data['tanggal_zakat']; ?></td>
            <td><?php echo $data['status_zakat']; ?></td>
            <td><?php echo $data['status_uang_zakat']; ?></td>
        </tr>
    <?php } ?>
    </tbody>
...
<script>
	...
	var link = "<?php echo site_url('Laporan_infaq')?>";
...
<div class="modal fade" id="modalKonfirmasi" tabindex="-1" role="dialog" aria-labelledby="modalKonfirmasiLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  <form class="form" id="KonfirmasiStatus" data-url="<?php echo base_url('Laporan_infaq/konfirmasi'); ?>">
