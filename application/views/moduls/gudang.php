...
<?php $title = "<i class='fa fa-file-image-o'></i>&nbsp;Gudang"; ?>
...
<div class="widget-header">
		...
		<h4 class="widget-title">Form gudang</h4>
...
<form id="form-add" class="form-horizontal" action="<?= site_url('Gudang/ajax_add')?>" method="POST" role="form" enctype="multipart/form-data">

	 <input type="hidden" name="fc_kdgudang">
	...
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Judul </label>
		...
		<div class="col-sm-10">
			...
			<input type="text" id="fv_nmgudang" name="fv_nmgudang" placeholder="Judul" class="col-xs-10 col-sm-5" />
	...
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Deskripsi </label>
		...
		<div class="col-sm-6">
			...
			<textarea class="form-control" id="fv_alamat" name="fv_alamat" placeholder="Deskripsi" class="col-xs-10 col-sm-5" cols="30" rows="10"></textarea>
...
<div class="tabbable">
	...
	<form action="#" id="form" name="form" class="form-horizontal" enctype="multipart/form-data">
		...
		<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Nama Gudang </label>
			...
			<div class="col-sm-10">
				...
				<input type="text" id="fv_nmgudang" name="fv_nmgudang" placeholder="fv_nmgudang" class="col-xs-10 col-sm-5" />
		...
		<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Alamat Gudang </label>

			<div class="col-sm-6">

				<textarea class="form-control" id="fv_alamat" name="fv_alamat" placeholder="Deskripsi" class="col-xs-10 col-sm-5"></textarea>
	...
	<form id="form-upload" class="form-horizontal" role="form" action="<?= site_url('Gudang/upload')?>" method="POST" enctype="multipart/form-data">
...
<script>
	...
	function update(id) {
			...
			$.ajax({
				...
				// var img = '<?= base_url(); ?>assets/images/'+result.fc_slider_gambar;

				$('[name="fc_kdgudang"]').val(result.fc_kdgudang);

				$('[name="fv_nmgudang"]').val(result.fv_nmgudang);
