    ...
    <div class="container">
            ...
            <table align="center">
                <tr>
                    <td colspan="2" style="text-align: center;">
                        ...
                        <h5 class="up" id="nama">Laporan Order</h5>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="disp">
            ...
            <?php foreach($print as $trans) {
                if($trans["fc_status_kirim"] == 1){
                $status = "Belum melakukan pembayaran, Silahkan lakukan pembayaran";
            }
            elseif($trans["fc_status_kirim"] == 2){
                $status = "Menunggu Konfirmasi admin, silahkan tunggu selama 2x24 jam";
            }
            elseif($trans["fc_status_kirim"] == 3){
                $status = "Admin telah menghubungi penjual untuk segera mengirim pesanan";
            }
            elseif($trans["fc_status_kirim"] == 4){
                $status = "Penjual Telah mengirim pesanan";
            }
            elseif($trans["fc_status_kirim"] == 5){
                $status = "Pesanan telah diterima pembeli,terima kasih";
            }else{
                $status = "Pesanan telah lunas";
            }?>
                <tr>
                    <td><?php echo $trans["fc_kdorder"]; ?></td>
                    <td><?php echo $trans["fv_nama_order"]; ?></td>
                    <td><?php echo $trans["fv_alamat_order"]; ?></td>
                    <td><?php echo $trans["fc_telp"]; ?></td>
                    <td><?php echo $trans["fd_tgl_order"]; ?></td>
