...
<?php $title = "<i class='fa fa-money'></i>&nbsp;Laporan Stock Barang"; ?>
...
<div class="box-header">
  <form id="formAksine" class="form-horizontal" action="<?php echo base_url('Laporan_stock/prints') ?>" target="_blank" method="POST" role="form" enctype="multipart/form-data">
  <div class="form-group">
    <div class="col-sm-6">
    <select name="id_gdg" class="form-control">
    <option value="">Pilih Nama Gudang Yang Akan di Cetak</option>
    <?php foreach ($gdg as $u) { ?>
    <option value="<?php echo $u["fc_kdgudang"] ?>"><?php echo $u["fv_nmgudang"] ?></option>
    <?php } ?>
    </select>
