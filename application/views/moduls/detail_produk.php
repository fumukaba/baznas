...
<div class="tabbable">
	...
	<div class="tab-content">
		<div id="home" class="tab-pane fade in active">
			...
			<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Deskripsi </label>
				<div class="col-sm-6">
					<textarea class="form-control" id="teksarea<?php echo @$id_produk;?>" name="detail_deskripsi" placeholder="Deskripsi" class="col-xs-10 col-sm-5" cols="30" rows="10"></textarea>
					<span class="help-block"></span>
				</div>
			</div>
			<div class="form-group">
			...
			<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Detail Deskripsi Meta </label>
				<div class="col-sm-6">
					<textarea class="form-control" id="teks<?php echo @$id_produk;?>" name="detail_deskripsi_meta" placeholder="Deskripsi" class="col-xs-10 col-sm-5" cols="30" rows="10"></textarea>
					<span class="help-block"></span>
				</div><br /><br /><br /><br />
				<div class="col-md-offset-2 col-md-9">
...
<script>
	...
	function ckeditor2(){
		tinymce.init({
			selector: "#teksarea<?php echo @$id_produk;?>"
		});
	}
	
	function ckeditor3(){
		tinymce.init({
			selector: "#teks<?php echo @$id_produk;?>"
		});
	}
	...
	function edit(id) {
			...
			var my_editor_id = 'teksarea<?php echo @$id_produk;?>';
			var my_editor_id2 = 'teks<?php echo @$id_produk;?>';
			// set the content empty
			tinymce.get(my_editor_id).setContent(''); 
			tinymce.get(my_editor_id2).setContent(''); 
			$.ajax({
				...
				tinymce.editors[5].setContent(result.detail_deskripsi_meta);
