...
<head>
<meta charset="utf-8">
<title>Pencairan Poin Document</title>
            ...
            <table align="center">
                <tr>
                    <td colspan="2" style="text-align: center;">
                        ...
                        <h5 class="up" id="nama">Laporan Pencairan Poin</h5>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="disp">
            ...
            <?php foreach($print as $trans) { ?>
                <tr>
                    ...
                    <td><?php if($trans["sisa_poin"] == null){
                      echo "-";  
                    } echo $trans["sisa_poin"]; ?></td>
                </tr>
            <?php } ?>
            </table>
        </div>
