...
<div class="box-header" style="padding-bottom: 70px;">
    ...
    <form action="<?php echo base_url(); ?>Import_infaq/index" method="POST" enctype="multipart/form-data">
        <div class="form-row">
            <div class="col-md-6">
...
<table id="example" class="display responsive nowrap" cellspacing="0" width="100%">
    ...
    <?php
		...
		foreach($sheet as $row){ 
			...
			if($numrow > 1 && $zis == 'Infaq'){
                array_push($data, array('nama_pengirim' => $pengirim, 'telp_pengirim' => $kontak, 'jumlah_infaq' => $jumlah, 'tanggal_infaq' => $tanggal, 'nama_zis' => $tempat));
...
<?php if(isset($sheet)) { ?>
<form action="<?php echo base_url(); ?>Import_infaq/import" method="POST" style="padding-top: 20px;">
    <div class="form-row">
