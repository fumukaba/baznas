...
<?php $title = "<i class='fa fa-briefcase'></i>&nbsp;Bank"; ?>
...
<form class="form-horizontal" role="form" id="formAksi">
	...
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Nama Bank </label>
		...
		<div class="col-sm-10">
			...
			<input type="text" id="jenis_bank" name="jenis_bank" placeholder="Nama Bank" class="col-xs-10 col-sm-5" />
	...
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Atas Nama </label>
		...
		<div class="col-sm-10">
			...
			<input type="text" id="atas_nama_bank" name="atas_nama_bank" placeholder="Atas Nama" class="col-xs-10 col-sm-5" />
	...
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> No. Rekening </label>
		...
		<div class="col-sm-10">
			...
			<input type="text" id="no_rekening" name="no_rekening" placeholder="No. Rekening" class="col-xs-10 col-sm-5" />
