...
<form id="form-add" class="form-horizontal" action="<?= site_url('Slider/ajax_add')?>" method="POST" role="form" enctype="multipart/form-data">
	...
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Judul </label>
		...
		<div class="col-sm-10">
			...
			<input type="text" id="fv_slider_judul" name="fv_slider_judul" placeholder="Judul" class="col-xs-10 col-sm-5" />
	...
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Deskripsi </label>
		...
		<div class="col-sm-6">
			...
			<textarea class="form-control" id="fv_slider_deskripsi" name="fv_slider_deskripsi" placeholder="Deskripsi" class="col-xs-10 col-sm-5" cols="30" rows="10"></textarea>
	...
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Gambar(1920X930) </label>
...
<div class="tabbable">
	...
	<form id="form-upload" class="form-horizontal" role="form" action="<?= site_url('Slider/upload')?>" method="POST" enctype="multipart/form-data">
		...
		<div class="form-body">
			...
			<label class="control-label col-md-3">Pilih File (1920X930)</label>
...
<script class="init">
	...
	function update(id) {
			...
			$.ajax({
				...
				$('[name="a1"]').val(result.fv_slider_judul);

				tinymce.editors[1].setContent(result.fv_slider_deskripsi);
