...
<?php $title = "<i class='fa fa-user'></i>&nbsp;Mutasi Uang"; ?>
...
<script>
	var save_method;
	var link = "<?php echo site_url('Mutasi_uang')?>";
	var table;
	...
	$(document).ready(function() {
        ...
        "ajax": {
            "url": "<?php echo site_url('Mutasi_uang/ajax_list')?>",
            "type": "POST"
        },
...
<div class="widget-box">
<div class="widget-header">
		<h4 class="widget-title">Mutasi Uang</h4>
...
<script>
    $(document).ready(function() {
        mutasi = function(_this) {
            var id = _this.data('id'),
                nama = _this.data('nama'),
                masuk = _this.data('masuk'),
                keluar = _this.data('keluar'),
                sisa = _this.data('sisa');
